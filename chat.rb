...
c = AI::Chat.new
#c.add("You are an assistant that speaks like a pirate", role: "system")
#c.add("What's the best pizza in Chicago?")
#c.user("What is in this image?", images: ["images/1.webp", "images/2.png"])

c.model = "o4-mini"
c.web_search = true
c.system("You are an expert nutritionist. Do your best to estimate the macros and calories in the provided images. Search the web if it will help.")
c.schema = '{
...
c.user("estimate nutrition in this meal I had at Ciccio Mio in Chicago", images: ["images/1.webp", "images/2.png"])
pp c.generate!
